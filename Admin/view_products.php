...
//                    $result_count= mysqli_query($con, $get_count);
                            $sql = "Select * from `orders_pending` where product_id= ?"; // SQL with parameters
                        ...
                        <td><a href='Admin_panel.php?delete_product=<?php echo $product_id; ?>' class='text-light'><i class='fa-solid fa-trash'></i></a></td>
                    </tr>
                    <?php
                }
                ?>
