...
//    $result_query=mysqli_query($con,$insert_products);
    $sql = "insert into `products` (product_title,product_description,product_keywords,category_id,brand_id,product_image1,product_image2,product_image3,product_price,date,status) values (?,?,?,?,?,?,?,?,?,NOW(),?)"; // SQL with parameters
$stmt = $con->prepare($sql); 
$stmt->bind_param("sssiisssis", $product_title,$description,$product_keywords,$product_category,$product_brands,$product_image1,$product_image2,$product_image3,$product_price,$product_status);
$stmt->execute();
